...
- The `p=agent` semantics — mechanically determined by whether the agent published itself, never asserted — is load-bearing; don't loosen it in `SKILL.md` or `index.html`.
